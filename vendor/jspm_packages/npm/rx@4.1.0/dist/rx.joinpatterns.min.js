...
(function(a) {
  ...
  function i(a, b) {
    return function() {
      var c = x(a.selector).apply(a, arguments);
      return c === w ? b.onError(c.e) : void b.onNext(c);
    };
  }
  function j(a, b, c) {
    var d = a.get(b);
  ...
  function k(a, b, c) {
    this.joinObserverArray = a, this.onNext = b, this.onCompleted = c, this.joinObservers = new y;
    for (var d = 0,
  ...
  var l = c.Observable,
      ...
      o = l.throwError,
      p = c.Observer.create,
      q = c.SingleAssignmentDisposable,
      r = c.CompositeDisposable,
      s = c.internals.AbstractObserver,
      t = c.helpers.noop,
      u = c.internals.inherits,
      v = c.helpers.isFunction,
      w = {e: {}},
      x = c.internals.tryCatch = function(a) {
        if (!v(a))
  ...
  f.prototype.and = function(a) {
    ...
    for (var d = [],
      ...
      d.push(j(a, this.expression.patterns[f], e));
    var l = new k(d, i(this, b), function() {
      for (var a = 0,
          b = d.length; b > a; a++)
        d[a].removeActivePlan(l);
      c(l);
    });
    for (f = 0, g = d.length; g > f; f++)
      d[f].addActivePlan(l);
    return l;
  }, k.prototype.dequeue = function() {
    this.joinObservers.forEach(function(a) {
      a.queue.shift();
    });
  }, k.prototype.match = function() {
    var a,
        b,
        c = !0;
  ...
  var z = function(a) {
    function b(b, c) {
      a.call(this), this.source = b, this.onError = c, this.queue = [], this.activePlans = [], this.subscription = new q, this.isDisposed = !1;
    }
    u(b, a);
    var c = b.prototype;
    ...
    }, c.error = t, c.completed = t, c.addActivePlan = function(a) {
