  ...
  (function(a) {
    ...
    function E(b) {
      ...
      if (!d && "string" == typeof b)
        return c = new z(b), c[kb]();
      if (!d && b.length !== a)
        return c = new B(b), c[kb]();
      if (!d)
    ...
    function ia(a, b, c) {
      ...
      if (ga(a) || "[object HTMLCollection]" === e)
        for (var f = 0,
            g = a.length; g > f; f++)
          d.add(ia(a.item(f), b, c));
      else
        a && d.add(new ha(a, b, c));
      return d;
    }
    function ja(a, b, c) {
 ...
 while (null !== k);
    ...
    !function(a) {
      ...
      a.schedulePeriodic = function(a, b, c) {
        if ("undefined" == typeof Pa.setInterval)
          throw new hb;
        b = oc(b);
        var d = a,
    ...
    var qc,
        rc,
        sc = Qa.internals.SchedulePeriodicRecursive = function() {
          function a(a) {
            return function(b, c) {
              c(0, a._period);
        ...
        xc = function() {
          var a,
              b = Ra;
          if (Pa.setTimeout)
            a = Pa.setTimeout, b = Pa.clearTimeout;
          else {
            if (!Pa.WScript)
              throw new hb;
            a = function(a, b) {
    ...
    !function() {
      ...
      function b() {
        if (!Pa.postMessage || Pa.importScripts)
          return !1;
        var a = !1,
            b = Pa.onmessage;
      ...
      if (Ya(h))
        ...
        qc = "document" in Pa && "onreadystatechange" in Pa.document.createElement("script") ? function(b) {
    ...
    var Mc,
        Nc = Qa.internals.AbstractObserver = function(a) {
          function b() {
            this.isStopped = !1;
          }
    ...
    Mc.toPromise = function(a) {
      if (a || (a = Qa.config.Promise), !a)
        throw new hb("Promise type not provided nor in Rx.config.Promise");
      var b = this;
      ...
      return pc(d) || (d = wc), new kd(a, e, d);
        ...
        pd = function(a) {
          ...
          function c(a, b) {
            if (a.first)
              a.first = !1;
            else if (a.newState = $a(a.self._itrFn)(a.newState), a.newState === Za)
        ...
        zd = function(a) {
          ...
          return Wb(b, a), b.prototype.subscribeCore = function(a) {
            var b = dc,
                c = $a(this._resFn)();
            if (c === Za)
              return new jc(yd(c.e).subscribe(a), b);
            c && (b = c);
        ...
        Ed = function(a) {
          ...
          return Wb(b, a), b.prototype.next = function(a) {
            if (this._state.values[this._i] = a, this._state.hasValue[this._i] = !0, this._state.hasValueAll || (this._state.hasValueAll = this._state.hasValue.every(Sa))) {
              ...
              this._state.isDone.filter(c(this._i)).every(Sa) && this._o.onCompleted();
          }, b.prototype.error = function(a) {
            this._o.onError(a);
          }, b.prototype.completed = function() {
        ...
        ce = function(a) {
          ...
          return Wb(b, a), b.prototype.next = function(a) {
            if (this._q[this._i].push(a), this._q.every(c)) {
              ...
              this._d.filter(e(this._i)).every(Sa) && this._o.onCompleted();
          }, b.prototype.error = function(a) {
            this._o.onError(a);
          }, b.prototype.completed = function() {
        ...
        ee = function(a) {
          ...
          return Wb(b, a), b.prototype.next = function(a) {
            if (this._s.q[this._i].push(a), this._s.q.every(c)) {
              ...
              this._s.done.filter(e(this._i)).every(Sa) && this._s.o.onCompleted();
          }, b.prototype.error = function(a) {
            this._s.o.onError(a);
          }, b.prototype.completed = function() {
    ...
    Mc.slice = function(a, b) {
      var c = a || 0;
      if (0 > c)
        throw new Qa.ArgumentOutOfRangeError;
    ...
    oa.prototype.and = function(a) {
      ...
      for (var d = [],
        ...
        d.push(sa(a, this.expression.patterns[f], e));
    ...
    Mc.delay = function() {
      ...
      if (Sc.isObservable(a) || Ya(a))
        return za(this, a, arguments[1]);
      throw new Error("Invalid arguments");
    };
    var Sf = function(a) {
      function b(b, c, d) {
    ...
    Mc.debounce = function() {
      if (Ya(arguments[0]))
        return Aa(this, arguments[0]);
      if ("number" == typeof arguments[0])
        return new Sf(this, arguments[0], arguments[1]);
      throw new Error("Invalid arguments");
    ...
    _f.prototype = Object.create(Error.prototype), Mc.timeout = function() {
      ...
      if (a instanceof Date || "number" == typeof a)
        return Ca(this, a, arguments[1], arguments[2]);
      if (Sc.isObservable(a) || Ya(a))
    ...
    var ag = function(a) {
      ...
      function c(a, b) {
        if (a.hasResult && a.o.onNext(a.result), a.first)
          ...
          return a.o.onError(a.newState.e);
        if (a.hasResult = $a(a.self._cndFn)(a.newState), a.hasResult === Za)
          return a.o.onError(a.hasResult.e);
        if (a.hasResult) {
          if (a.result = $a(a.self._resFn)(a.newState), a.result === Za)
