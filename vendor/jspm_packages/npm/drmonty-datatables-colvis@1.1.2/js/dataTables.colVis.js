  ...
  (function(window, document, undefined) {
    var factory = function($, DataTable) {
      ...
      ColVis.prototype = {
        ...
        "_fnDrawCallback": function() {
          ...
          var allVisible = function(columnIndeces) {
            for (var k = 0,
                kLen = columnIndeces.length; k < kLen; k++) {
          ...
          var allHidden = function(columnIndeces) {
            for (var m = 0,
                mLen = columnIndeces.length; m < mLen; m++) {
        ...
        "_fnAddGroups": function() {
          ...
          if (typeof this.s.aoGroups != 'undefined') {
            for (var i = 0,
                iLen = this.s.aoGroups.length; i < iLen; i++) {
        ...
        "_fnDomRestoreButton": function() {
          ...
          return $('<li class="ColVis_Special ' + (dt.bJUI ? 'ui-button ui-state-default' : '') + '">' + this.s.restore + '</li>').click(function(e) {
            for (var i = 0,
                iLen = that.s.abOriginal.length; i < iLen; i++) {
        ...
        "_fnDataTablesApiIndex": function() {
          for (var i = 0,
              iLen = this.s.dt.oInstance.length; i < iLen; i++) {
      ...
      ColVis.fnRebuild = function(oTable) {
        ...
        for (var i = 0,
            iLen = ColVis.aInstances.length; i < iLen; i++) {
