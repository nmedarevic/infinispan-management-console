    ...
    (function(t, n) {
      ...
      function D() {
        ...
        if (r === "e" || r === "E") {
          ...
          if (y(r)) {
            ...
            r = "character " + r, f >= h && (r = "<end>"), R({}, s.UnexpectedToken, "ILLEGAL");
        }
      ...
      function H() {
        ...
        while (f < h) {
          t = u[f++], e += t;
          if (t === "\\")
            t = u[f++], S(t) && R({}, s.UnterminatedRegExp), e += t;
          else if (a)
            t === "]" && (a = !1);
          else {
            if (t === "/") {
      ...
      function et() {
        ...
        if (e.type === t.Identifier)
          return i = Z(), e.value === "get" && !V(":") ? (n = Z(), W("("), W(")"), {
            type: r.Property,
            key: n,
            value: Y([]),
            kind: "get"
          }) : e.value === "set" && !V(":") ? (n = Z(), W("("), e = I(), e.type !== t.Identifier ? (W(")"), U(e, s.UnexpectedToken, e.value), {
            type: r.Property,
            key: n,
            value: Y([]),
            kind: "set"
      ...
      function rt() {
        ...
        if (n === t.StringLiteral || n === t.NumericLiteral)
          return a && e.octal && U(e, s.StrictOctalLiteral), ln(F());
        if (n === t.Keyword) {
          if ($("this"))
            return F(), {type: r.ThisExpression};
          if ($("function"))
            return Zt();
        }
      ...
      function ct() {
        var e = ft(),
            n;
        return n = I(), n.type !== t.Punctuator ? e : ((V("++") || V("--")) && !q() && (a && e.type === r.Identifier && k(e.name) && U({}, s.StrictLHSPostfix), Q(e) || U({}, s.InvalidLHSInAssignment), e = {
      ...
      function ht() {
        var e,
            n;
        return e = I(), e.type !== t.Punctuator && e.type !== t.Keyword ? ct() : V("++") || V("--") ? (e = F(), n = ht(), a && n.type === r.Identifier && k(n.name) && U({}, s.StrictLHSPrefix), Q(n) || U({}, s.InvalidLHSInAssignment), n = {
          type: r.UpdateExpression,
          operator: e.value,
          argument: n,
          prefix: !0
      ...
      function Tt() {
        var e,
            t;
        return e = I(), t = xt(), J() && (Q(t) || U({}, s.InvalidLHSInAssignment), a && t.type === r.Identifier && k(t.name) && U(e, s.StrictLHSAssignment), t = {
      ...
      function It() {
        var e,
            ...
            u,
            a;
        return e = t = n = null, X("for"), W("("), V(";") ? F() : ($("var") || $("let") ? (d.allowIn = !1, e = Ft(), d.allowIn = !0, e.declarations.length === 1 && $("in") && (F(), i = e, o = Nt(), e = null)) : (d.allowIn = !1, e = Nt(), d.allowIn = !0, $("in") && (Q(e) || U({}, s.InvalidLHSInForIn), F(), i = e, o = Nt(), e = null)), typeof i == "undefined" && W(";")), typeof i == "undefined" && (V(";") || (t = Nt()), W(";"), V(")") || (n = Nt())), W(")"), a = d.inIteration, d.inIteration = !0, u = Qt(), d.inIteration = a, typeof i == "undefined" ? {
          type: r.ForStatement,
          init: e,
          test: t,
          update: n,
      ...
      function $t() {
        var e;
        return X("catch"), W("("), V(")") && z(I()), e = Lt(), a && k(e.name) && U({}, s.StrictCatchVariable), W(")"), {
          type: r.CatchClause,
          param: e,
          body: kt()
        };
      ...
      function rn(e, t, n, r, i) {
        ...
        if (v.comments.length > 0 && v.comments[v.comments.length - 1].range[1] > n)
          return;
        v.comments.push({
          type: e,
          value: t,
      ...
      function mn(e) {
        ...
        for (n in e)
          e.hasOwnProperty(n) && n !== "groupRange" && n !== "groupLoc" && (r = e[n], r === null || typeof r != "object" || r instanceof RegExp ? t[n] = r : t[n] = mn(r));
        return t;
      }
      function gn(e, t) {
        return function(n) {
      ...
      }), e.version = "1.0.4", e.parse = En, e.Syntax = function() {
        var e,
            t = {};
  ...
  (inBrowser ? window : exports).blanket = function() {
    ...
    return inBrowser && typeof window.blanket != "undefined" && (n = window.blanket.noConflict()), _blanket = {
      ...
      instrument: function(e, t) {
        var n = e.inputFile,
            r = e.inputFileName;
        if (_blanket.options("instrumentCache") && sessionStorage && sessionStorage.getItem("blanket_instrument_store-" + r))
          _blanket.options("debug") && console.log("BLANKET-Reading instrumentation from cache: ", r), t(sessionStorage.getItem("blanket_instrument_store-" + r));
        else {
          var i = _blanket._prepareSource(n);
          _blanket._trackingArraySetup = [], n = n.replace(/^\#\!.*/, "");
      ...
      _trackBranch: function(e, t) {
        ...
        var i = "_$branchFcn('" + t + "'," + n + "," + r + "," + e.test.source() + ")?" + e.consequent.source() + ":" + e.alternate.source();
        e.update(i);
      },
      _addTracking: function(t) {
        ...
        return function(r) {
          ...
          if (e.indexOf(r.type) > -1 && r.parent.type !== "LabeledStatement") {
            ...
            if (r.type === "VariableDeclaration" && (r.parent.type === "ForStatement" || r.parent.type === "ForInStatement"))
              return;
            if (!r.loc || !r.loc.start)
              throw new Error("The instrumenter encountered a node with no location: " + Object.keys(r));
            r.update(n + "['" + t + "'][" + r.loc.start.line + "]++;\n" + r.source()), _blanket._trackingArraySetup.push(r.loc.start.line);
          } else
            _blanket.options("branchTracking") && r.type === "ConditionalExpression" && _blanket._trackBranch(r, t);
        };
      },
      _checkDefs: function(e, t) {
        if (inBrowser) {
          e.type === "VariableDeclaration" && e.declarations && e.declarations.forEach(function(n) {
            if (n.id.name === "window")
              throw new Error("Instrumentation error, you cannot redefine the 'window' variable in  " + t + ":" + e.loc.start.line);
          }), e.type === "FunctionDeclaration" && e.params && e.params.forEach(function(n) {
            if (n.name === "window")
              throw new Error("Instrumentation error, you cannot redefine the 'window' variable in  " + t + ":" + e.loc.start.line);
          });
          if (e.type === "ExpressionStatement" && e.expression && e.expression.left && e.expression.left.object && e.expression.left.property && e.expression.left.object.name + "." + e.expression.left.property.name === _blanket.getCovVar())
            throw new Error("Instrumentation error, you cannot redefine the coverage variable in  " + t + ":" + e.loc.start.line);
        } else if (e.type === "ExpressionStatement" && e.expression && e.expression.left && !e.expression.left.object && !e.expression.left.property && e.expression.left.name === _blanket.getCovVar())
          throw new Error("Instrumentation error, you cannot redefine the coverage variable in  " + t + ":" + e.loc.start.line);
      },
    ...
    e.extend({
      ...
      report: function(t) {
        ...
        if (typeof e.options("reporter") == "string")
          e._loadFile(e.options("reporter")), e.customReporter(t, e.options("reporter_options"));
        else if (typeof e.options("reporter") == "function")
          e.options("reporter")(t, e.options("reporter_options"));
        else {
          if (typeof e.defaultReporter != "function")
            throw new Error("no reporter defined.");
          e.defaultReporter(t, e.options("reporter_options"));
        }
      },
      ...
      _loadSourceFiles: function(t) {
        ...
        if (i.length === 0)
          ...
          sessionStorage.blanketSessionLoader && (e.blanketSession = JSON.parse(sessionStorage.blanketSessionLoader)), i.forEach(function(t, n) {
            e.utils.cache[t] = {loaded: !1};
          });
          var s = -1;
          e.utils.loadAll(function(e) {
            return e ? typeof i[s + 1] != "undefined" : (s++, s >= i.length ? null : i[s]);
          }, t);
        }
      },
    ...
    function g(e, t, n, r, i) {
      ...
      var u = n[e],
          a = u.consequent;
      if (a.start.line > i)
        m.unshift([u.alternate, u]), m.unshift([a, u]), t = d(t);
      else {
        ...
        var c = u.alternate;
        if (c.start.line > i)
          s += d(t.slice(a.end.column - r)), m.unshift([c, u]);
        else {
    ...
    var t = "#blanket-main {margin:2px;background:#EEE;color:#333;clear:both;font-family:'Helvetica Neue Light', 'HelveticaNeue-Light', 'Helvetica Neue', Calibri, Helvetica, Arial, sans-serif; font-size:17px;} #blanket-main a {color:#333;text-decoration:none;}  #blanket-main a:hover {text-decoration:underline;} .blanket {margin:0;padding:5px;clear:both;border-bottom: 1px solid #FFFFFF;} .bl-error {color:red;}.bl-success {color:#5E7D00;} .bl-file{width:auto;} .bl-cl{float:left;} .blanket div.rs {margin-left:50px; width:150px; float:right} .bl-nb {padding-right:10px;} #blanket-main a.bl-logo {color: #EB1764;cursor: pointer;font-weight: bold;text-decoration: none} .bl-source{ overflow-x:scroll; background-color: #FFFFFF; border: 1px solid #CBCBCB; color: #363636; margin: 25px 20px; width: 80%;} .bl-source div{white-space: pre;font-family: monospace;} .bl-source > div > span:first-child{background-color: #EAEAEA;color: #949494;display: inline-block;padding: 0 10px;text-align: center;width: 30px;} .bl-source .miss{background-color:#e6c3c7} .bl-source span.branchWarning{color:#000;background-color:yellow;} .bl-source span.branchOkay{color:#000;background-color:transparent;}",
        ...
        s = document.body,
        o,
        u = Object.keys(e.files).some(function(t) {
      ...
      for (L = 0; L < T.source.length; L += 1) {
        ...
        if (m.length > 0 || typeof T.branchData != "undefined")
          if (typeof T.branchData[L + 1] != "undefined") {
            ...
            m.length ? O = g(0, O, null, 0, L + 1).src : O = d(O);
        else
          O = d(O);
        var D = "";
      ...
      if (typeof T.branchData != "undefined")
        for (var B = 0; B < T.branchData.length; B++)
          if (typeof T.branchData[B] != "undefined")
            for (var j = 0; j < T.branchData[B].length; j++)
              typeof T.branchData[B][j] != "undefined" && (P++, typeof T.branchData[B][j][0] != "undefined" && T.branchData[B][j][0].length > 0 && typeof T.branchData[B][j][1] != "undefined" && T.branchData[B][j][1].length > 0 && H++);
    ...
    t.call(n[n.length - 1].attributes).forEach(function(t) {
      ...
      if (t.nodeName === "data-cover-reporter-options")
        try {
    ...
    e.extend({utils: {
        ...
        processFile: function(t, n, r, i) {
          ...
          typeof o != "undefined" && e.utils.matchPatternAttribute(n, o) ? (i(t), e.options("debug") && console.log("BLANKET-File will never be instrumented:" + n), e.requiringFile(n, !0)) : e.utils.matchPatternAttribute(n, s) ? (e.options("debug") && console.log("BLANKET-Attempting instrument of:" + n), e.instrument({
            inputFile: t,
            inputFileName: n
          }, function(i) {
            try {
        ...
        cacheXhrConstructor: function() {
          ...
          if (typeof XMLHttpRequest != "undefined")
            e = XMLHttpRequest, this.createXhr = function() {
              return new e;
            };
