...
!function(a, b) {
  ...
  function u(a) {
    return (a ? "" : "[múlt] ") + "[" + Da[this.day()] + "] LT[-kor]";
  }
  function v(a, b) {
    var c = {
  ...
  function K(a, b, c, d) {
    var e = a + " ";
    return 1 === a ? e + H(a, b, c[0], d) : b ? e + (I(a) ? J(c)[1] : J(c)[0]) : d ? e + J(c)[1] : e + (I(a) ? J(c)[1] : J(c)[2]);
  }
  function L(a, b) {
  ...
  function R(a, b, c) {
    ...
    switch (c) {
      ...
      case "mm":
        return d + (Q(a) ? "minuty" : "minut");
      case "h":
        return b ? "godzina" : "godzinę";
      case "hh":
        return d + (Q(a) ? "godziny" : "godzin");
      case "MM":
        return d + (Q(a) ? "miesiące" : "miesięcy");
      case "yy":
        return d + (Q(a) ? "lata" : "lat");
    }
  }
  function S(a, b, c) {
    var d = {
  ...
  function U(a, b, c) {
    ...
    return "m" === c ? b ? "минута" : "минуту" : a + " " + T(d[c], +a);
  }
  function V(a, b) {
    var c = {
  ...
  function Z(a, b, c, d) {
    ...
    switch (c) {
      ...
      case "mm":
        return b || d ? e + (Y(a) ? "minúty" : "minút") : e + "minútami";
        break;
      case "h":
        return b ? "hodina" : d ? "hodinu" : "hodinou";
      case "hh":
        return b || d ? e + (Y(a) ? "hodiny" : "hodín") : e + "hodinami";
        break;
      case "d":
        return b || d ? "deň" : "dňom";
      case "dd":
        return b || d ? e + (Y(a) ? "dni" : "dní") : e + "dňami";
        break;
      case "M":
        return b || d ? "mesiac" : "mesiacom";
      case "MM":
        return b || d ? e + (Y(a) ? "mesiace" : "mesiacov") : e + "mesiacmi";
        break;
      case "y":
        return b || d ? "rok" : "rokom";
      case "yy":
        return b || d ? e + (Y(a) ? "roky" : "rokov") : e + "rokmi";
    }
  }
  function $(a, b, c, d) {
    var e = a + " ";
  ...
  function aa(a, b, c) {
    ...
    return "m" === c ? b ? "хвилина" : "хвилину" : "h" === c ? b ? "година" : "годину" : a + " " + _(d[c], +a);
  }
  function ba(a, b) {
    var c = {
  ...
  }
  {
    var ea = (a.defineLocale("af", {
      ...
      0: "٠"
        ...
        la = ["كانون الثاني يناير", "شباط فبراير", "آذار مارس", "نيسان أبريل", "أيار مايو", "حزيران يونيو", "تموز يوليو", "آب أغسطس", "أيلول سبتمبر", "تشرين الأول أكتوبر", "تشرين الثاني نوفمبر", "كانون الأول ديسمبر"],
        ma = (a.defineLocale("ar", {
          months: la,
          monthsShort: la,
          weekdays: "الأحد_الإثنين_الثلاثاء_الأربعاء_الخميس_الجمعة_السبت".split("_"),
          weekdaysShort: "أحد_إثنين_ثلاثاء_أربعاء_خميس_جمعة_سبت".split("_"),
        ...
        sa = "led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split("_"),
        ta = (a.defineLocale("cs", {
          months: ra,
          monthsShort: sa,
        ...
        ya = ["nolla", "yhden", "kahden", "kolmen", "neljän", "viiden", "kuuden", xa[7], xa[8], xa[9]],
        za = (a.defineLocale("fi", {
        ...
        Aa = "jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_"),
        Ba = (a.defineLocale("fy", {
          months: "jannewaris_febrewaris_maart_april_maaie_juny_july_augustus_septimber_oktober_novimber_desimber".split("_"),
          monthsShort: function(a, b) {
            return /-MMM-/.test(b) ? Aa[a.month()] : za[a.month()];
          },
        ...
        Fa = "sekmadienis_pirmadienis_antradienis_trečiadienis_ketvirtadienis_penktadienis_šeštadienis".split("_"),
        Ga = (a.defineLocale("lt", {
        ...
        Ha = (a.defineLocale("lv", {
          ...
          translate: function(a, b, c) {
            var d = Ha.words[c];
            return 1 === c.length ? b ? d[0] : d[1] : a + " " + Ha.correctGrammaticalCase(a, d);
          }
        }),
        Ia = (a.defineLocale("me", {
        ...
        Qa = (a.defineLocale("nl", {
          months: "januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december".split("_"),
          monthsShort: function(a, b) {
            return /-MMM-/.test(b) ? Pa[a.month()] : Oa[a.month()];
          },
        ...
        Sa = (a.defineLocale("pl", {
          months: function(a, b) {
            return "" === b ? "(" + Ra[a.month()] + "|" + Qa[a.month()] + ")" : /D MMMM/.test(b) ? Ra[a.month()] : Qa[a.month()];
          },
        ...
        Ta = "jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec".split("_"),
        Ua = (a.defineLocale("sk", {
          months: Sa,
          monthsShort: Ta,
          monthsParse: function(a, b) {
            var c,
      ...
      calendar: {
        ...
        lastWeek: function() {
          switch (this.day()) {
            ...
            case 5:
            case 6:
              return da("[Минулої] dddd [").call(this);
            case 1:
            case 2:
            case 4:
              return da("[Минулого] dddd [").call(this);
          }
        },
        sameElse: "L"
      },
